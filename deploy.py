    ...
    if st.session_state.model_type:
        ...
        if col2.button('Upload Excel File'):
            ...
            if st.session_state.model_type == 'Binary':
                st.image("main/images/excel_format_binary.png", caption="Excel format example for Binary Model")
            elif st.session_state.model_type == 'Ternary':
                st.image("main/images/excel_format_ternary.png", caption="Excel format example for Ternary Model")
